...
class GetVehiclesResponseModel
    extends BaseResponseModel<PageModel<VehicleModel, VehicleEntity>> {
  const GetVehiclesResponseModel({
    required super.success,
    super.data,
    super.message,
    super.error,
  });
  factory GetVehiclesResponseModel.fromJson(Map<String, dynamic> json) =>
      GetVehiclesResponseModel(
