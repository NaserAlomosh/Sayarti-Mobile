...
CurrenciesResponseModel _$CurrenciesResponseModelFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$CurrenciesResponseModelToJson(CurrenciesResponseModel instance) =>
    <String, dynamic>{
