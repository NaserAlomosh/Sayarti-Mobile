...
part of 'general_statistics_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GeneralStatisticsModel _$GeneralStatisticsModelFromJson(
  ...
  totalExpenseAmountByCurrency:
      (json['totalExpenseAmountByCurrency'] as List<dynamic>)
          .map((e) => CurrencyTotalModel.fromJson(e as Map<String, dynamic>))
          .toList(),
  activeReminderCount: (json['activeReminderCount'] as num).toInt(),
  completedReminderCount: (json['completedReminderCount'] as num).toInt(),
);

Map<String, dynamic> _$GeneralStatisticsModelToJson(
  GeneralStatisticsModel instance,
) => <String, dynamic>{
  ...
  'totalExpenseAmountByCurrency': instance.totalExpenseAmountByCurrency
      .map((e) => e.toJson())
      .toList(),
  'activeReminderCount': instance.activeReminderCount,
  'completedReminderCount': instance.completedReminderCount,
};
