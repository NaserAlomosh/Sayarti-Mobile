...
class UpdateVehicleRequestModel {
 const UpdateVehicleRequestModel({this.brand, this.model, this.year, this.powertrainType, this.licensePlate, this.nickname, this.imageUrl, this.fuelType, this.fuelTankCapacityLiters, this.batteryCapacityKwh, this.estimatedRangeKm});
 ...
 final String? licensePlate; final String? nickname; final String? imageUrl;
 ...
 factory UpdateVehicleRequestModel.fromJson(Map<String,dynamic> json) => _$UpdateVehicleRequestModelFromJson(json);
