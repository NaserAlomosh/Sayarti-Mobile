...
class VerifyEmailUseCase
    extends BaseRemoteUsecase<LoginContentEntity, VerifyEmailUseCaseParams> {
  ...
  ) => _repository.verifyEmail(params);
}

class VerifyEmailUseCaseParams extends BaseUsecaseParams {
