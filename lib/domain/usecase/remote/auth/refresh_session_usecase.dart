...
class RefreshSessionUseCase
    extends BaseRemoteUsecase<LoginContentEntity, RefreshSessionUseCaseParams> {
  ...
  ) => _repository.refresh(params);
}

class RefreshSessionUseCaseParams extends BaseUsecaseParams {
  const RefreshSessionUseCaseParams({required this.refreshToken});
